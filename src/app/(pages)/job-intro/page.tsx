		...
		<div className="my-[5%] bg-[#F0EBDC] pt-[55px] pb-[30px]">
			...
			<div className="mx-[3%] mt-[1%] grid grid-cols-1 gap-4 rounded-md bg-white sm:grid-cols-2 lg:grid-cols-3">
				<JobIntroduction
					...
					alt="test"
					title="PC貸出"
					text='ICTを用いた学びを支援するカメラや充電器、ブースの貸出を行います。貸出機器の一覧は<a href="https://www.google.co.jp/" target=blank class="text-blue-500 underline">こちら</a>'
				/>
				<JobIntroduction
					image="/images/floor01.jpg"
					alt="test"
					title="機器貸出"
					text="ICTを用いた学びを支援するカメラや充電器、ブースの貸出を行います。貸出機器の一覧はこちら"
				/>
				<JobIntroduction
					image="/images/floor01.jpg"
					alt="test"
